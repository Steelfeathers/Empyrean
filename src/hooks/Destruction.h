...
namespace Hooks
{
	...
	public:
		...
		static void ProcessMagicEffectAdded_DES(RE::Actor* a_target, RE::Actor* a_caster, RE::ActiveEffect* a_effect, RE::MagicItem* a_spell);
	...
	private:
		...
		//static RE::EffectSetting* SplitMagicEffect(RE::EffectSetting* origEffect);
	};
}
